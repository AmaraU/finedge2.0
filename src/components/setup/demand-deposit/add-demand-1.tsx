    ...
    <>
      ...
      <div className="grid grid-cols-3 gap-[20px] px-[16px] py-[12px]">
        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <select className="p-[4px] rounded-[6px] bg-[#F8FAFC] w-full border-[#ECEFF3] border-[1px]">
        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <input
            ...
            type="text"
          />
          <p className="text-[#9CA3AF] font-medium text-[12px]">%(Annualize)</p>
        </div>
        <div className="w-full flex flex-col gap-2">
          <p className="text-[#64748B] font-medium text-[14px]">
            Max NDIC Limit
        ...
        <div className="w-full flex flex-col gap-2">
          <p className="text-[#64748B] font-medium text-[14px]">Short Name</p>
          <input
            className="py-[4px] rounded-[6px] bg-[#F8FAFC] w-full border-[#ECEFF3] border-[1px]"
            type="text"
          />
      ...
      <div className="grid grid-cols-3 gap-[20px] px-[16px] py-[12px]">
        <div className="w-full flex flex-col gap-2">
          ...
          <input
            ...
            type="text"
          />
          <p className="text-[#9CA3AF] font-medium text-[12px]">(Per annum)</p>
        </div>
...
export default AddDemandDepositStep1;
